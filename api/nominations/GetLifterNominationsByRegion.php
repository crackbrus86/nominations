<?php
    ...
    if(empty($_SESSION["regionObj"])){
        ...
        $tb_nominations.deadlift, $tb_nominations.total, $tb_nominations.personally, $tb_nominations.status, $tb_nominations.city, $tb_nominations.fst, $tb_nominations.school,
