<?php
    ...
    if(empty($_SESSION["regionObj"])){
        ...
        is_official = %s, duty = %s, is_referee = %s, ref_category = %s, ref_remark = %s, competition = %d WHERE id=%d", 
        $type, $surname, $firstName, $team, $isOfficial, $duty, $isReferee, $refCategory, $refRemark, $competition, $id);
