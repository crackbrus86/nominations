<?php
    ...
    if(empty($_SESSION["regionObj"])){
        ...
        $sql = $wpdb->prepare("SELECT id, status, surname, first_name AS firstName, middle_name AS middleName, ref_category AS refCategory, ref_remark AS refRemark FROM $tb_nominations WHERE competition = %d AND
